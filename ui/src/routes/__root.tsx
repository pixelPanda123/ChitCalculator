...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "MyPaisaa chit borrowing and savings analysis." },
      { name: "author", content: "MyPaisaa" },
      { property: "og:title", content: "MyPaisaa Chit Calculator" },
      { property: "og:description", content: "MyPaisaa chit borrowing and savings analysis." },
